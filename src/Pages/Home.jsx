...
const Home = () => {
    return (
        <div>
            ...
            <main>
                <a target="_blank" href="https://api.whatsapp.com/send?phone=917300042095&text=Hello%20Saffron%2C%20I%20want%20Online%20Cricket%20ID%20with%2010%25%20Extra%20bonus%20Source%3A-%20MMC%2C%20AD" className="enq-side-btn-icone"><i className="fab fa-whatsapp" /> Click Here to Get ID</a>
                        ...
                        <div className="row justify-content-center">
                            <div className="col-xl-9">
                                <div className="slider-content text-center">
                                    <div className="logo">
                                        <a target="_blank" href="https://api.whatsapp.com/send?phone=917300042095&text=Hello%20Saffron%2C%20I%20want%20Online%20Cricket%20ID%20with%2010%25%20Extra%20bonus%20Source%3A-%20MMC%2C%20AD"><img src="./images/saffronexch-logo.jpg" alt="Logo" width="200px" /></a>
                                    </div>
                                    ...
                                    <a target="_blank" href="https://api.whatsapp.com/send?phone=917300042095&text=Hello%20Saffron%2C%20I%20want%20Online%20Cricket%20ID%20with%2010%25%20Extra%20bonus%20Source%3A-%20MMC%2C%20AD" className="btn wow fadeInUp" data-wow-delay="2.2s">Whatsapp Now For Create Id</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="game-single-content">
                                    <div className="upcoming-game-head">
                                        <div className="uc-game-head-title">
                                            <h4>welcome in The Family of <span>Saffron "Khelo Dil and Dimag Se" - Oldest Fantasy Sports provider</span></h4>
                                        </div>
                                        <a target="_blank" href="https://api.whatsapp.com/send?phone=917300042095&text=Hello%20Saffron%2C%20I%20want%20Online%20Cricket%20ID%20with%2010%25%20Extra%20bonus%20Source%3A-%20MMC%2C%20AD">
                                    ...
                                    <div className="footer-widget mb-50">
                                        ...
                                        <div className="footer-social">
                                            <ul>
                                                ...
                                                <li><a href="https://api.whatsapp.com/send?phone=917300042095&text=Hello%20Saffron%2C%20I%20want%20Online%20Cricket%20ID%20with%2010%25%20Extra%20bonus%20Source%3A-%20MMC%2C%20AD"><FaWhatsapp /></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
