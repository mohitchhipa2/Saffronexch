            ...
            <div className="row justify-content-center">
              <div className="col-xl-9">
                <div className="slider-content text-center">
                  <div style={{ marginTop: "20px" }} className="logo">
                  ...
                  <a style={{ marginBottom: "30px" }} href="https://api.whatsapp.com/send?phone=917300042095&text= %20I%20want%20Online%20Cricket%20ID%20with%2010%25%20Extra%20bonus%20Source%3A-%20MMC%2C%20AD" target="_blank" className="btn wow fadeInUp" data-wow-delay="2.2s">Whatsapp </a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="row second-row">
              <div className="col-md-4">
                <li style={{ height: "22vh" }} className="newaddere asdfgh">
                  <h5>Address:</h5>India
              ...
              <div className="col-md-4">
                <li className="newaddere">
                  <h5>Phone:</h5>
                  <a style={{ color: 'black' }} href="https://api.whatsapp.com/send?phone=917300042095&text=%20I%20want%20Online%20Cricket%20ID%20with%2010%25%20Extra%20bonus%20Source%3A-%20MMC%2C%20AD">
                    <a><FaWhatsapp /> </a>Whatsapp
                  </a></li>
              </div>
            </div>
          </div>
